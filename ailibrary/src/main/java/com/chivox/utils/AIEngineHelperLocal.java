...
public class AIEngineHelperLocal {

    private static String TAG = "AIEngineHelperLocal";
    ...
    private static void writeFileAsString(File file, String str)
            throws IOException {
     ...
     */
    public static String registerDeviceOnce(Context context, String appKey,
                                            String secretKey, String deviceId, String userId) {
