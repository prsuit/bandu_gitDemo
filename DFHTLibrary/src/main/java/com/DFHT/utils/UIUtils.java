...
import com.DFHT.manager.ThreadManager;
...
public class UIUtils {
    ...
    public static Context getContext() {
        return ENBaseApplication.getApplication();
    }

    public static Thread getMainThread() {
        return ENBaseApplication.getMainThread();
    }

    public static long getMainThreadId() {
        return ENBaseApplication.getMainThreadId();
    }
    ...
    public static Handler getHandler() {
        // 获得主线程的looper
        Looper mainLooper = ENBaseApplication.getMainThreadLooper();
        // 获取主线程的handler
