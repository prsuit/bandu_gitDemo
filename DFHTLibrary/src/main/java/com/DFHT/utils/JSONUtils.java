...
//            return JSON.toJSONString(object);
    ...
    private static String getJsonForUpload(Map object){
        ...
        try {
            jsonObject = new JSONObject(wmJson);
            JSONArray sentences = jsonObject.getJSONArray("sentences");
            for (int i = 0; i < sentences.length(); i++) {
                JSONObject o = (JSONObject) sentences.get(i);
                String words_score = o.getString("words_score");
                LogUtils.i("words_score == " + words_score);
                JSONArray words_scoreArray = new JSONArray(words_score);
                o.remove("words_score");
                o.put("words_score", words_scoreArray);
            }
     ...
     * @return
     */
    public static String getJson(Object object, String name) {
