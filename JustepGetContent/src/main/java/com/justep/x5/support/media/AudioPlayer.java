...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    public AudioPlayer(AudioHandler handler, String id, String file) {
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            this.tempFile = Environment.getExternalStorageDirectory().getAbsolutePath() + "/tmprecording.wav";
        } else {
            this.tempFile = "/data/data/" + handler.getBaseContext().getPackageName() + "/cache/tmprecording.wav";
        }
    ...
    public void startRecording(String file) {
        ...
        case NONE:
            ...
            this.recorder.setOutputFormat(MediaRecorder.OutputFormat.AAC_ADTS); // THREE_GPP);
    ...
    public String getFullPath(String file){
        if (!file.startsWith("/")) {
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                file = "/data/data/" + handler.getBaseContext().getPackageName() + "/cache/" + file;
            }
        }
        return file;
    }
    ...
    private void loadAudioFile(String file) throws IllegalArgumentException, SecurityException, IllegalStateException, IOException {
        if (this.isStreaming(file)) {
            ...
            if (file.startsWith("/android_asset/")) {
                ...
                android.content.res.AssetFileDescriptor fd = this.handler.getBaseContext().getAssets().openFd(f);
