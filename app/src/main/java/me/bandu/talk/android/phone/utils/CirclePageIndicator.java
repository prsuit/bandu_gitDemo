...
public class CirclePageIndicator  extends View {
    ...
    public interface PageChange extends ViewPager.OnPageChangeListener{}

    public void setChange(PageChange change) {
        this.change = change;
    }

    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle, TextView tv) {
    ...
    public void setViewPager(ViewPager view) {
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if(change !=null)
                    change.onPageSelected(position);
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if(change !=null)
                    change.onPageScrolled(position,positionOffset,positionOffsetPixels);
                mCurrentPage = position;
            ...
            public void onPageScrollStateChanged(int state) {
                if(change !=null)
                    change.onPageScrollStateChanged(state);
                mScrollState = state;
