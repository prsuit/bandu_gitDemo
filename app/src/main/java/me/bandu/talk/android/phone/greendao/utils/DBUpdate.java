                ...
                if (nowVersion + 1 != newVersion) {
                    ...
                    switch (nowVersion + 1) {
                        case DBVERSION_TWO://版本号是2的时候
                            myUpgrade_2(db);
                            break;
                        case DBVERSION_THREE://版本号是3的时候
//                            myUpgrade_3(db);
                            break;
                        case DBVERSION_SI://版本号是4的时候
//                            myUpgrade_4(db);
                            break;
                    }
                    nowVersion += 1;
...
//        db.execSQL("ALTER TABLE " + TaskDirectoryTabelDao.TABLENAME + " ADD " + TaskDirectoryTabelDao.DESCRIPTION + " TEXT");
//        db.execSQL("ALTER TABLE " + TaskDirectoryTabelDao.TABLENAME + " ADD " + TaskDirectoryTabelDao.QUIZ_TYPE + " TEXT");
//        db.execSQL("ALTER TABLE " + BestSentenceTabelDao.TABLENAME + " ADD " + BestSentenceTabelDao.ANSWER + " TEXT");
//        db.execSQL("ALTER TABLE " + CurrentSentenceTabelDao.TABLENAME + " ADD " + CurrentSentenceTabelDao.ANSWER + " TEXT");
    }
