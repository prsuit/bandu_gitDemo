...
public class ClassTabelDao extends AbstractDao<ClassTabelBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property taskLatestTime = new Property(3, Long.class, "taskLatestTime", false, TASKLATESTTIME);
        public final static Property isShowReddot = new Property(4, String.class, "isShowReddot", false, ISSHOWREDDOT);
        public final static Property classState = new Property(5, Long.class, "classState", false, CLASSSTATE);
        public final static Property className = new Property(6, String.class, "className", false, CLASSNAME);
    }
