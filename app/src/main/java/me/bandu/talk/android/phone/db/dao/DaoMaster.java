...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        LessonBeanDao.createTable(db, ifNotExists);
        PartBeanDao.createTable(db, ifNotExists);
        CentenceBeanDao.createTable(db, ifNotExists);
        DownloadBeanDao.createTable(db, ifNotExists);
        MyWrodBeanDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        UnitBeanDao.dropTable(db, ifExists);
        LessonBeanDao.dropTable(db, ifExists);
        PartBeanDao.dropTable(db, ifExists);
        CentenceBeanDao.dropTable(db, ifExists);
        DownloadBeanDao.dropTable(db, ifExists);
        MyWrodBeanDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(MyWrodBeanDao.class);
    }
