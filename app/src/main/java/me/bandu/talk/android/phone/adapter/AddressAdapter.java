...
public class AddressAdapter extends BaseAdapter implements SectionIndexer {
	private List<AddressBean.DataEntity.ListEntity> list = null;
	private Context mContext;

	public AddressAdapter(Context mContext, List<AddressBean.DataEntity.ListEntity> list) {
		this.mContext = mContext;
		this.list = list;
	}

	public void updateListView(List<AddressBean.DataEntity.ListEntity> list) {
		this.list = list;
