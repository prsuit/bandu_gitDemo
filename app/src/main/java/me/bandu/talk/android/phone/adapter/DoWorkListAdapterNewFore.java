...
public class DoWorkListAdapterNewFore extends DoWorkListBaseAdapter {
    ...
    public DoWorkListAdapterNewFore(Detail detail, Context context, String currentType, boolean showBaseWork, ListView lv, long classID, long stu_job_id) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String[] split = list.get(position).getEn().split("#");
        ...
        holder.tvContent.setText(sbEn.toString(), TextView.BufferType.SPANNABLE);
