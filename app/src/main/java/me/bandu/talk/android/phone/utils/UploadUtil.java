...
public class UploadUtil {
    ...
    public static final String CONTENT_TYPE = "multipart/form-data"; // 内容类型
    public UploadUtil() {
    ...
    public int readTimeOut = 15 * 1000; // 读取超时
    public int connectTimeout = 15 * 1000; // 超时时间
    /***
     * 请求使用多长时间
     */
    ...
    public void uploadFileAndEntity(){
