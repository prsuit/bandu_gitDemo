...
import me.bandu.talk.android.phone.adapter.PersonAdapter;
...
import me.bandu.talk.android.phone.widget.Graph;
...
//                    else
                    myOnclik.myOnclik(topNum, position, adapter.clikPosition != -2);
//                    if (!isReverse)
//                        myOnclik.myOnclik(topNum,Integer.valueOf(graphListList.get(graphListList.size() - position - 1).getJob_id()), adapter.clikPosition != -2);
//                    else
//                        myOnclik.myOnclik(topNum,Integer.valueOf(graphListList.get(position).getJob_id()), adapter.clikPosition != -2);
                }
                dismissPopupWindow();
                break;
        }
    ...
    private void showPopupWindow(View v, String text) {
        ...
        layout.setBackgroundResource(R.drawable.wwww);
