...
import com.justep.x5.support.chooser.FileUploadChooserActivity;
...
public class TencentWebChromeClient extends WebChromeClient {
    ...
    protected final TencentWebViewEngine parentEngine;
    ...
    public TencentWebChromeClient(TencentWebViewEngine parentEngine) {
    ...
    public void openFileChooser(final ValueCallback<Uri> uploadMsg, String acceptType, String capture){
        Intent intent = new Intent(parentEngine.cordova.getActivity(), FileUploadChooserActivity.class);
    ...
    public boolean onShowFileChooser(WebView webView, final ValueCallback<Uri[]> filePathsCallback, final FileChooserParams fileChooserParams) {
        ...
        try {
            parentEngine.cordova.startActivityForResult(new CordovaPlugin() {
                @Override
                public void onActivityResult(int requestCode, int resultCode, Intent intent) {
                    Uri[] result = JustepEnhanceTbsUtils.parseFileChooserResult(resultCode, intent);
                    Log.d(LOG_TAG, "Receive file chooser URL: " + result);
                    filePathsCallback.onReceiveValue(result);
                }
            }, intent, FILECHOOSER_RESULTCODE);
        } catch (ActivityNotFoundException e) {
            Log.w("TencentWebChromeClient","No activity found to handle file chooser intent.");
