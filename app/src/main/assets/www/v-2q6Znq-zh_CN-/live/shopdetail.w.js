...
var __parent0=require('$model/UI2/live/shopdetail'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='c3uqqaa';
	this._flag_='bf5c69340698b94972297cf10c213051';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"fee":{"define":"fee","label":"金额","name":"fee","relation":"fee","type":"String"},"id":{"define":"id","label":"用户ID","name":"id","relation":"id","type":"String"},"time":{"define":"time","label":"购买时间","name":"time","relation":"time","type":"String"},"title":{"define":"title","label":"课程标题","name":"title","relation":"title","type":"String"}},"directDelete":false,"events":{},"idColumn":"id","limit":20,"xid":"shopData"});
}}); 
return __result;});
