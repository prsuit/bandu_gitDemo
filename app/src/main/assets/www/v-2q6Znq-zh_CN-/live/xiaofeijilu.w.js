...
var __parent0=require('$model/UI2/live/xiaofeijilu'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cfmymQ3';
	this._flag_='caa362eec57ad94b7c90717d31cc296a';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"sumamount":{"define":"sumamount","label":"费用","name":"sumamount","relation":"sumamount","type":"String"},"time":{"define":"time","label":"消费时间","name":"time","relation":"time","type":"String"},"tradeNo":{"define":"tradeNo","label":"订单号","name":"tradeNo","relation":"tradeNo","type":"String"},"user_id":{"define":"user_id","label":"用户ID","name":"user_id","relation":"user_id","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"PurchaseHistoryCustomRefresh"},"idColumn":"user_id","limit":20,"xid":"PurchaseHistory"});
}}); 
return __result;});
